...
//   - OURA_NO_RETRY=true short-circuit
...

{
  ...
  const retryLogs = captured.filter((m) => m.startsWith('[oura-mcp] retry'));
...
captured.length = 0;
process.env.OURA_NO_RETRY = 'true';
{
  let calls = 0;
...
delete process.env.OURA_NO_RETRY;
